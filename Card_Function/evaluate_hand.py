...
def get_winners(player_list: list[Player],table:Table) -> list[Player]:
    ...
    winners =[p for p in active_players if p.currentRank == best_rank]
    for W in winners:
        W.currentMoney+=table.pot//len(winners)
    return winners